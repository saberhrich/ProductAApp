...
public class AddEditContact extends AppCompatActivity {
    ...
    private EditText Libelle,Code,Price;
    private FloatingActionButton fab;


    //String variable;
    private String id,image,libelle,code,price,addedTime,updatedTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Libelle = findViewById(R.id.Libelles);
...
//       ContentValues for image info
    ...
    private void saveData() {
        ...
        libelle = Libelle.getText().toString();
        code = Code.getText().toString();
        price = Price.getText().toString();

        //Toast.makeText(getApplicationContext(),radioButton.getText().toString(),Toast.LENGTH_LONG);
        ...
        //check filed data
        if (!libelle.isEmpty() || !code.isEmpty() || !price.isEmpty() ){
